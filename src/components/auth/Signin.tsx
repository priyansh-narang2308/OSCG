    ...
    <div className="min-h-screen bg-[#090E1A] flex items-center justify-center px-4">
      <div className="bg-[#2B303B] text-white w-full max-w-md rounded-2xl shadow-xl p-8 space-y-6 mt-[100px] mb-[100px]">
        ...
        <div className="space-y-3">
          ...
          <Button
            className="w-full bg-white text-[#111827] hover:bg-[#e5e7eb] cursor-pointer flex items-center justify-center gap-2"
      ><svg
        ...
        <form className="space-y-4">
          ...
          <div>
            <label className="text-[14px] text-[#FCFBF8]">Password</label>
            <div className="relative mt-1">
              ...
              <button
                ...
                className="absolute right-3 top-3 text-gray-400 hover:text-[#11D493] cursor-pointer transition-colors"
              >
